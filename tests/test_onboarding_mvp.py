...
def _server_hermes_home() -> pathlib.Path:
    ...
    conftest is imported multiple times under different EBURON_HOME environments
    (api.config resets EBURON_HOME at module import time via init_profile_state).
    """
