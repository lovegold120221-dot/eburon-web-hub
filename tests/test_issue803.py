...
def test_switch_profile_process_wide_false_does_not_mutate_global():
    ...
    original_env_home = os.environ.get('EBURON_HOME')
    ...
    try:
        ...
        # EBURON_HOME env must not change
        assert os.environ.get('EBURON_HOME') == original_env_home, (
            "process_wide=False must not mutate os.environ['EBURON_HOME']"
        )
