...
- **Sprint 25** — macOS desktop application. Native Swift + WKWebView shell, universal Intel + Apple Silicon DMG, Sparkle 2 auto-update. Lives in the separate `eburon-webui/eburon-swift-mac` repo.
...
- **Plugin marketplace** — Eburon Hub skills already cover this surface.
